...
import '../../../../submission/presentation/pages/submission_create_page.dart';
import '../../../../submission/presentation/pages/submission_detail_page.dart';
import '../../../../submission/presentation/pages/widgets/submission_card.dart';
    ...
    return Obx(() {
      ...
      if (items.isEmpty) {
        return AppEmptyState(
          ...
          subtitle: 'Tekan tombol "Buat Pengajuan" untuk membuat pengajuan baru.',
        );
      }
