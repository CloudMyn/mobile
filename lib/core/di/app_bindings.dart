...
import '../../features/skp/data/repositories/skp_report_repository.dart';
...
class AppBindings extends Bindings {
  ...
  void dependencies() {
    ...
    // ── Submission ────────────────────────────────────────────────────────────
    Get.put<SubmissionService>(ApiSubmissionService(dio), permanent: true);
    ...
    // ── SKP (Laporan Bulanan) ──────────────────────────────────────────────────
    Get.put<SkpReportRepository>(ApiSkpReportRepository(dio), permanent: true);
    Get.lazyPut<SkpListController>(
      () => SkpListController(repository: Get.find<SkpReportRepository>()),
      fenix: true,
    );
  }
}
